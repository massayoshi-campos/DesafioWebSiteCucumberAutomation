...
import br.com.valid.cd.misc.Mouse;
...
public class Utils {
	...
	/**
	 * Aguardando 200 segundos para que um elemento esteja presente na p�gina,
	 * verificando por sua presenca uma vez a cada 5 segundos.
	 */
	...
	/**
	 * Metodo para verificar a visibilidade de um elemento utilizando o locator
	 * 
	 * @param locator
	 */
	...
	/**
	 * Metodo para verificar a visibilidade de um elemento utilizando o ID
	 * 
	 * @param id
	 */
	...
	/**
	 * Metodo que valida a url de uma nova janela/popup aberta e alterna entre as 2
	 * janelas
	 * 
	 * @param url
	 * @param timeWait
	...
	public static void testWindowURL(String url, int timeWait) throws InterruptedException {
		...
		for (String windowHandle : windowHandles) {
			// Se o windowHandle N�O � igual ao windowHandle da janela inicial, eu sei que �
			// o da nova janela, ent�o mando o WebDriver mudar para ela
	...
	/**
	 * Metodo duplo clique no campo e informa novo valor.
	 * 
	 * @param locator
	 * @param valor
	 */
	...
	/**
	 * Metodo para verificar a presenca de um elemento utilizando o ID
	 * 
	 * @param id
	 */
	...
	/**
	 * Metodo para verificar se um elemento e clicavel utilizando o locator
	 * 
	 * @param locator
	 */
	...
	/**
	 * Metodo para verificar se um elemento e clicavel utilizando o ID
	 * 
	 * @param id
	 */
	...
	/*
	 * 
	 * Metodo para verificar o texto presente em um campo input
	 * 
	 * @param locator
	 */
	...
	/**
	 * Metodo para capturar screenshot da tela
	 * 
	 * @param fileName
	 *            - Nome do arquivo
	 */
	...
	/**
	 * O valor do campo desable e verifica a informacao.
	 * 
	 * @param idField
	 * @return
	 */
	...
	/**
	 * Metodo para o robo realizar o upload de arquivos dentro da pagina.
	 * 
	 * @param string
	 */
	...
	/**
	 * Metodo para o o usuario informar as coordenadas X e Y para o robo clicar.
	 * 
	 * @param cordenada1
	 * @param cordenada2
	 * @throws Exception
	 */
	public static void mouseCordenadaClick(int cordenada1, int cordenada2) throws Exception {
		Mouse mouse = new Mouse();
		mouse.mouseClick(cordenada1, cordenada2, 1);

	}

	/**
	 * Metodo da ferramenta sikuli que clica no botao inserindo no pathButtom o
	 * caminho da imagem.
	 * 
	 * @throws Exception
	 */
	...
	/**
	 * M�todo da ferramenta sikuli que preenche o campo texto usando a imagem.
	 * 
	 * @param texto
	 * @throws FindFailed
	 * @throws InterruptedException
	...
	/**
	 * M�todo para deletar os certificados do browser
	 * 
	...
	public static void deleteCertificateFromMy(String... aliasesToPreserve) {
		try {
			...
			for (String aliasToRemove : aliasesToRemove) {
				System.out.println("Certificado " + aliasToRemove + " sera removido");
